...
async function fetchData() {
    try {
        ...
        // Ambil response sebagai text dulu (anti error JSON)
...
document.getElementById('form-barang').addEventListener('submit', async function (e) {
    ...
    try {
        ...
        const text = await response.text();
        console.log("Tambah Response:", text);
        ...
        try {
            ...
            throw new Error("Response tambah bukan JSON");
        }
...
async function hapusBarang(id) {
    ...
    try {
        ...
        try {
            ...
            throw new Error("Response hapus bukan JSON");
        }

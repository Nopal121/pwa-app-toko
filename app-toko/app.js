// ============================================
// APP.JS - PWA TOKO DENGAN SEARCH, PAGINATION, CHART
// ============================================
...
async function renderDashboard() {
    try {
        ...
        // Dapatkan tipe chart dari select
        ...
        // Untuk line chart, tambahkan fill dan tension
        if (chartType === 'line') {
            datasetConfig = {
                ...datasetConfig,
                fill: true,
        ...
        // Untuk pie/doughnut, gunakan warna per item
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Load chart setelah delay (biar DOM siap)
    setTimeout(() => {
        renderDashboard();
    }, 500);
});
